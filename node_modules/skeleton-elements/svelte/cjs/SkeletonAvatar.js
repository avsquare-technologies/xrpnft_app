/* SkeletonAvatar.svelte generated by Svelte v3.38.3 */
"use strict";

const { SvelteComponent, append, assign, attr, create_slot, detach, element, exclude_internal_props, get_spread_update, init, insert, safe_not_equal, set_attributes, space, svg_element, transition_in, transition_out, update_slot } = require("svelte/internal");
const { default: multiplySvgPoints } = require("./multiply-svg-points");
...
exports.default = SkeletonAvatar;